...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['place_order'])) {
    ...
    $new_order_id = create_order($order_data, $cart_items);
    $_SESSION['cart'] = [];
    $order_placed = true;
}
        ...
        <?php if ($order_placed): ?>
            ...
            <div class="success-wrapper">
                ...
                <div style="display:flex;gap:14px;justify-content:center;flex-wrap:wrap;margin-top:10px;">
                    <?php if ($new_order_id): ?>
                        <a href="receipt.php?order_id=<?= $new_order_id ?>" class="btn-home" style="background:#9BB374;">
                        ...
                        <div class="checkout-card">
                            ...
                            <div class="form-row">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="first_name" class="form-control" value="<?= htmlspecialchars($_SESSION['first_name'] ?? '') ?>" required>
                                </div>
                                <div class="form-group">
                                    <label class="form-label">Last Name</label>
                                    <input type="text" name="last_name" class="form-control" value="<?= htmlspecialchars($_SESSION['last_name'] ?? '') ?>" required>
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input type="tel" name="phone" class="form-control" value="<?= htmlspecialchars($_SESSION['phone'] ?? '') ?>" placeholder="09XXXXXXXXX" required>
                            </div>
                            <div class="form-group">
                                <label class="form-label">Complete Address</label>
                                <input type="text" name="address" class="form-control" value="<?= htmlspecialchars($_SESSION['address'] ?? '') ?>" placeholder="House No., Street, Barangay, City, Province" required>
                            </div>
                            <div class="form-row">
                                <div class="form-group">
                                    <label class="form-label">City / Municipality</label>
                                    <input type="text" name="city" class="form-control" placeholder="e.g. Quezon City" required>
                                </div>
                                <div class="form-group">
                                    <label class="form-label">ZIP Code</label>
                                    <input type="text" name="zip_code" class="form-control" placeholder="e.g. 1100" required>
                                </div>
                            </div>
                        </div>
                            ...
                            ?>
                                <div class="summary-item">
                                    ...
                                    <div class="summary-item-info">
                                        ...
                                        <p>Qty: <?= $quantity ?> &times; <?= '₱' . number_format($p['price'], 2) ?></p>
                                    </div>
