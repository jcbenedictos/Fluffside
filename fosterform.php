...
<body>
    ...
    <footer class="site-footer">
        ...
        <i class="fas fa-paw footer-paw paw-1"></i>
        <i class="fas fa-paw footer-paw paw-2"></i>
        <i class="fas fa-paw footer-paw paw-3"></i>
        <i class="fas fa-paw footer-paw paw-4"></i>
        <i class="fas fa-paw footer-paw paw-5"></i>
        <h1>FOOTER</h1>
    </footer>
